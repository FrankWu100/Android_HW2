...
public class DailyCash extends Activity {
        ...
        btn1.setOnClickListener(new Button.OnClickListener(){
        	public void onClick(View v) {
        		...
        		if (txt1.getText().length() > 0)
        		{
        			...
        			getLotteryThread = new getDailyCash();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	AlertDialog.Builder infoMsg = new AlertDialog.Builder(DailyCash.this);
	 ...
	 void setControlEnabled(Boolean bool){
	    ...
	    {
	    	mypDialog = new ProgressDialog(DailyCash.this);
	 ...
	 int[] getRandomAns(int size, int range)
		...
		//新大樂透Function 執行序
		class getDailyCash extends Thread {
			public getDailyCash () {
